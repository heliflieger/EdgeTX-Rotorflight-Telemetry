...
M.build_ui = function(wgt)
    ...
    pMain:build({{type="box", x=0, y=0,
        children={
            ...
            {type="label", text=function() return getValue("PID#") end , x=6, y=10, font=FS.FONT_16 ,color=txtColor},
        }
    }})
    ...
    pMain:build({{type="box", x=44, y=0,
        children={
            ...
            {type="label", text=function() return getValue("RTE#") end , x=2, y=10, font=FS.FONT_16 ,color=txtColor},
        }
    }})
    ...
    pMain:build({{type="box", x=185, y=115,
        children={
            ...
            {type="label", text=function() return getValue("Hspd") end, x=0, y=10, font=FS.FONT_16 ,color=txtColor},
        }
    }})
