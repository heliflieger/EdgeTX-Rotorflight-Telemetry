...
M.build_ui = function(wgt)
    ...
    pMain:build({{type="box", x=74+280, y=150,
        children={
            ...
            {type="label", text=function() return getValue("RTE#") end , x=2, y=0, font=FS.FONT_16 ,color=txtColor},
        }
    }})
    ...
    --bStatusBar:label({x=380, y=2, text="VenbS & Shmuely", font=FS.FONT_6, color=GREY})
